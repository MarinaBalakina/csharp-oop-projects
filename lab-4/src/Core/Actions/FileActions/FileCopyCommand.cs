...
public class FileCopyCommand : ICommand
{
    ...
    public CommandResult Execute(CommandEnvironment environment)
    {
        ...
        {
            return CommandResult.Fail("Source file does not exist");
        }

        PathResult destinationResult =
            destination.Result ?? throw new InvalidOperationException("Destination file is not set");
        ...
        FileSystem.CopyFile(sourceResult.AbsolutePath, destinationResult.AbsolutePath);
